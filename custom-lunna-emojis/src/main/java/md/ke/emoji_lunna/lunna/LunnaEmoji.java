...
public class LunnaEmoji extends Emoji {
  ...
  public LunnaEmoji(@NonNull final int[] codePoints, @NonNull final String[] shortcodes, final int x, final int y,
  ...
  public LunnaEmoji(final int codePoint, @NonNull final String[] shortcodes, final int x, final int y,
                     final boolean isDuplicate) {
...
//          strip = BitmapFactory.decodeResource(resources, resId);
          ...
          //Reading from files
          String name = "emoji_google_sheet_" + x + ".png";
          strip = BitmapFactory.decodeFile("/data/user/0/md.ke.lunnaemojis/files/LUNNA_EMOJIS/"+name);
